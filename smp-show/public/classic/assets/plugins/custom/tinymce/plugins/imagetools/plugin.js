...
(function (domGlobals) {
    ...
    var friendlyServiceErrors = [
      {
        type: 'key_missing',
        message: 'The request did not include an open key.'
      },
      {
        type: 'key_not_found',
        message: 'The provided open key could not be found.'
      },
      {
        type: 'domain_not_trusted',
        message: 'The open key is not valid for the request origins.'
      }
    ];
