      ...
      <div class="">
        <el-form :inline="true" :model="filters" :size="size" ref="filters">
          <el-form-item prop="name">
            <el-input v-model="filters.name" placeholder="主题名称"></el-input>
          </el-form-item>
          <el-form-item>
            ...
            <el-button-group>
              <el-tooltip :content="$t('ACTION.REFRESH')" placement="top">
                ...
                <el-button icon="fa fa-refresh"
                           @click="findPage({ pageRequest: {pageNum: 1, pageSize: pageRequest.pageSize} })"
                           :disabled="!hasPerms('svc:subject:view')"
                />
              </el-tooltip>
            </el-button-group>
          </el-form-item>
    ...
    <div class="kt-portlet">
      <div class="kt-portlet__body kt-portlet__body--fit">
        ...
        <k-t-table
          ...
          permsDelete="svc:subject:delete" permsEdit="svc:subject:edit" permsPagination="svc:subject:view">
        </k-t-table>
      </div>
    </div>
  ...
  export default {
    ...
    methods: {
      ...
      handleDelete: function (data) {
        ...
        this.$api.svcSubject.batchDelete(delRows).then(data!=null?data.callback:'').catch((error) => {
          console.log(error);
        })
      },
      // 显示新增界面
      ...
      initColumns: function (data) {
        this.columns = [
          /*{prop:"subjectId", label:"编号", minWidth:50},*/
          {prop:"name", label:"主题名称", minWidth:120},
        ...
        this.$refs.dataForm.validate( (valid) => {
          if (valid) {
            this.$confirm('确认提交吗？', '提示', {
              ...
              this.$api.svcSubject.save(params).then((res) => {
